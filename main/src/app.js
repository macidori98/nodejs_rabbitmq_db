...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqplib.connect("amqps://xvholbwb:Ct0aABJnd52M1RFzXgnQf6MH0xjsNsiA@roedeer.rmq.cloudamqp.com/xvholbwb", function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            console.log("listenening on 8001");
            app.listen(8001);
